...
const valid = (vehicle) => Number.isFinite(Number(vehicle?.latitud)) && Number.isFinite(Number(vehicle?.longitud))
...
export default function MapaFlota({ vehicles = [] }) {
  ...
  return <View style={{ width: '100%', height: 400, marginTop: 8, marginBottom: 8, borderRadius: 14, overflow: 'hidden' }}>
