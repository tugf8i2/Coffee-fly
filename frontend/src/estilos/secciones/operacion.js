...
export const estilosOperacion = {
  mapPanel: { width: '100%', minHeight: 320, backgroundColor: colores.blanco, borderRadius: 14, padding: 12, overflow: 'hidden' },
  bagGroup: { width: '100%', backgroundColor: '#F2F8DF', borderRadius: 10, padding: 12, gap: 7, borderWidth: 1, borderColor: 'rgba(56,102,65,.18)' },
  statusActions: { flexDirection: 'row', flexWrap: 'wrap', gap: 7, marginTop: 4 },
  statusButton: { backgroundColor: colores.lima, paddingHorizontal: 10, paddingVertical: 8, borderRadius: 8 },
  ...
  deliveryHeader: { width: '100%', backgroundColor: '#EEF4D5', borderLeftWidth: 5, borderLeftColor: colores.verde, borderRadius: 12, padding: 16, gap: 5 },
