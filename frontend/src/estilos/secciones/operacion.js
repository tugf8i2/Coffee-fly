...
export const estilosOperacion = {
  ...
  bagGroup: { width: '100%', backgroundColor: '#F0F5EF', borderRadius: 11, padding: 14, gap: 8, borderWidth: 1, borderColor: 'rgba(56,102,65,.18)' },
  statusActions: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', gap: 8, marginTop: 5 },
  statusButton: { backgroundColor: colores.lima, paddingHorizontal: 12, paddingVertical: 12, minHeight: 44, borderRadius: 9, borderWidth: 1, borderColor: 'rgba(56,102,65,.18)' },
  statusButtonText: { color: colores.bosque, fontWeight: '700' },
  history: { gap: 4, marginTop: 6, paddingTop: 7, borderTopWidth: 1, borderColor: 'rgba(56,102,65,.18)' },
  deliveryHeader: { width: '100%', backgroundColor: '#EAF2EC', borderLeftWidth: 5, borderLeftColor: colores.verde, borderRadius: 13, padding: 18, gap: 6 },
  ...
  selectionHint: { color: colores.bosque, backgroundColor: '#F0F5EF', borderRadius: 9, padding: 12, fontWeight: '700' },
  totalBox: { backgroundColor: '#EAF2EC', borderRadius: 10, padding: 12, borderLeftWidth: 5, borderLeftColor: colores.verde },
  totalLabel: { color: colores.bosque, fontWeight: '700' },
  totalValue: { color: colores.bosque, fontSize: 27, fontWeight: '700' },
