...
export const estilosFormularios = {
  label: { fontSize: 14, lineHeight: 19, fontWeight: '700', color: colores.bosque, marginBottom: 5 },
  field: { width: '100%', maxWidth: 620, gap: 2 },
  input: { width: '100%', maxWidth: 620, minHeight: 48, backgroundColor: '#fff', borderWidth: 1, borderColor: 'rgba(56,102,65,.38)', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 11, fontSize: 16, lineHeight: 22, color: colores.tinta },
  ...
  primaryText: { color: '#fff', fontWeight: '700', fontSize: 15, lineHeight: 20, textAlign: 'center' },
  ...
  secondaryText: { color: colores.bosque, fontWeight: '700' },
  removeLink: { color: colores.error, fontWeight: '700', paddingVertical: 5 },
  link: { color: colores.bosque, fontWeight: '700', textAlign: 'center', paddingVertical: 9, textDecorationLine: 'underline' },
  ...
  readonly: { width: '100%', maxWidth: 620, backgroundColor: '#EAF2EC', color: colores.bosque, paddingHorizontal: 13, paddingVertical: 11, borderRadius: 9, fontWeight: '700', borderWidth: 1, borderColor: 'rgba(56,102,65,.16)' },
